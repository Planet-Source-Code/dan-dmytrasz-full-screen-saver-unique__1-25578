...
'This Modual was created by Igguk E-Mail : pcharles@swing.be
...
Public Const APP_NAME2 = "Igguk - Screen Saver"
Public Const APP_NAME = "Display Properties"
...
With MainForm
    Select Case RunMode
        ...
        Case "/S"
            'Run the screensaver
            'MsgBox FindWindow(vbNullString, APP_NAME)
            If App.PrevInstance And FindWindow(vbNullString, APP_NAME) = 0 Then End
